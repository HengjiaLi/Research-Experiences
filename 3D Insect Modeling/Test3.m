...
Path = 'E:\Cannon Images\2019_06_24\IMG_04';
% the path where the stacked images are stored, need to be changed to local
% directory
nim = 13;%total number of target images
ref_index = 1;% we use the last image of the stack as a reference image
...
for i = 1:nim
    IMG_cropped{i} = imresize(imread(strcat(Path,num2str(39+i),'.JPG')),0.25);
